...
d. 找到；提取并从 WatchTable 和 Watch2Paths 中删除对应 Watcher（从这里可以看出 Watcher 在服务端是一次性的，触发一次就失效了）
...
## ![image-20211113211143326](https://gitee.com/vicxsl/img/raw/master/img/1636809104094/image-20211113211143326.png)
