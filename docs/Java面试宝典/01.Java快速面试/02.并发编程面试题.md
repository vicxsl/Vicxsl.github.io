...
![image-20220622133535167](https://s2.loli.net/2022/06/22/A3qC4GgFeyhMRNP.png)
...
![image-20220622134017292](https://s2.loli.net/2022/06/22/OFfopBATMiVU8IH.png)
...
![image-20220622195444665](https://s2.loli.net/2022/06/22/yrahI2fMkuJ8RGg.png)
...
![image-20220622195657733](https://s2.loli.net/2022/06/22/mHRb8uxnPcf6zAh.png)
...
![image-20220622195729498](https://s2.loli.net/2022/06/22/3YDq9mE8U5swMhP.png)
...
![image-20220622200425370](https://s2.loli.net/2022/06/22/s1KJ6ZqnQ95EvXM.png)
...
- 每个Synchronized修饰过的代码当它的monitor被占用时就会处于锁定状态并且尝试获取monitor的所有权 ，过程：
...
###  Java Concurrency API 中的 Lock 接口(Lock interface)是什么？Lock 接口和synchronized 对比同步它有什么优势？
...
一般软件开发中容器用的最多的就是HashMap、ArrayList，LinkedList ，等等但是在多线程开发中就不能乱用容器，如果使用了未加锁（非同步）的的集合，你的数据就会非常的混乱。由此在多线程开发中需要使用的容器必须是加锁（同步）的容器。
...
![image-20220622204931043](https://s2.loli.net/2022/06/22/oKkE5zRXlauqeWL.png)

2. Vector添加源码（加锁了synchronized关键字）

![image-20220622204954934](https://s2.loli.net/2022/06/22/cw7HTaRnzQ3EFdD.png)
...
![image-20220622205038253](https://s2.loli.net/2022/06/22/NYREwzpS3VoB6rH.png)

2. HashTable添加方法的源码

![image-20220622205105459](https://s2.loli.net/2022/06/22/PBfRZio8v69kYIt.png)
...
![image-20220622205615439](https://s2.loli.net/2022/06/22/UOJBZI2St9RCdwk.png)
...
![image-20220622203151132](https://s2.loli.net/2022/06/22/xSIsLYaEC6Pc7AV.png)
...
Executor 框架是一个根据一组执行策略调用，调度，执行和控制的异步任务的框架。`Executors框架实现的就是线程池的功能。`

`Executor工厂类如何创建线程池图：`

![image-20220622203404950](https://s2.loli.net/2022/06/22/I6siCm9wKLo43Je.png)
...
![image-20220622203843130](https://s2.loli.net/2022/06/22/Th3VFojfsXIgWUy.png)
