...
![image-20220621111809050](https://s2.loli.net/2022/06/21/31eFKWnVkpmSUlr.png)
...
![image-20220621112015396](https://s2.loli.net/2022/06/21/f1ECz3DLBp6VrnU.png)
...
![image-20220621112106464](https://s2.loli.net/2022/06/21/UgaAVDI8kZuvQGw.png)
...
![image-20220621112448265](https://s2.loli.net/2022/06/21/59J2rj3LxpfuCSX.png)
...
两个对象的 hashCode() 相同，则 equals() 也一定为 true，对吗？ `不对`
...
```
解析：
![image-20220621132704078](https://s2.loli.net/2022/06/21/qWtr8AFajn6Ve7o.png)
...
```
解析：
![image-20220621132737397](https://s2.loli.net/2022/06/21/SJftuVgKe4oIw1R.png)
...
![image-20220621132755283](https://s2.loli.net/2022/06/21/QS82r9ecKnYsHqT.png)

交换之后：

![image-20220621132810241](https://s2.loli.net/2022/06/21/1EwDaQfnhiB5PtT.png)
...
![image-20220621132848347](https://s2.loli.net/2022/06/21/bidRJnse9pLZSKB.png)

按操作对象分类结构图：

![image-20220621132921959](https://s2.loli.net/2022/06/21/kh2LJw7blAn8vBR.png)
