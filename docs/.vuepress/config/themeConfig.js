...
module.exports = {
  ...
  repo: 'vicxsl/vicxsl.github.io', // 导航栏右侧生成Github链接
  ...
  author: {
    ...
    name: 'xushengli', // 必需
    link: 'https://github.com/vicxsl', // 可选的
  },
  blogger: {
    // 博主信息，显示在首页侧边栏
  ...
  social: {
    ...
    icons: [
      ...
      },
      {
        iconClass: 'icon-erji',
        title: '听音乐',
        link: 'http://music.163.com/playlist?id=2424753600',
      },
    ],
  },
  footer: {
    ...
    copyrightInfo:
      'Vic | <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
  },
